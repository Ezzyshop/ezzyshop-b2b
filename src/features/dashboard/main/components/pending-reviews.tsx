        ...
        {isLoading ? (
          ...
          <div className="divide-y">
            {pendingReviews.map((review) => {
              const productName =
                review.product?.name?.uz || review.product?.name?.ru || review.product?.name?.en || "";
              return (
                <Link
                  key={review._id}
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-medium truncate">{review.user.full_name}</p>
                  ...
                  <Button size="sm" variant="outline" className="h-7 text-xs px-2 shrink-0" asChild>
